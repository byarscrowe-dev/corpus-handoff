LAST-UPDATED: 2026-06-06 23:59 CT | SEQ: 11 | LEAD: Phase 2 CONGRESS family DEPLOYED + live-verified — 9 forward-only copy-bots; ingest live (House 234 docs + Senate, 5182 signals, 0 errors), pdfplumber installed, timer enabled, health OK; first forward snapshots Mon 6 PM CT
...
5. Expand `congress_leadership.csv` — only Wyden is seeded, and he trades municipal bonds, so `congress_leadership` is currently empty. Add real leaders/committee chairs + re-verify each new Congress.
